...
public class UTM2Deg {
	...
	UTM2Deg(String UTM) {
		...
		if (Hem == 'S')
			...
			north = Northing;
		latitude = (north / 6366197.724 / 0.9996 + (1 + 0.006739496742 * Math
				.pow(Math.cos(north / 6366197.724 / 0.9996), 2) - 0.006739496742
				* Math.sin(north / 6366197.724 / 0.9996)
				* Math.cos(north / 6366197.724 / 0.9996)
				* (Math.atan(Math.cos(Math.atan((Math.exp((Easting - 500000)
						...
						* (1 - 0.006739496742
						...
						/ Math.cos((north - 0.9996 * 6399593.625 * (north
								...
								* 5
								/ 3
								* (3 * (north / 6366197.724 / 0.9996 + Math
										.sin(2 * north / 6366197.724 / 0.9996) / 2) + Math
								...
								* 35
								/ 27
								* (5 * (3 * (north / 6366197.724 / 0.9996 + Math
										.sin(2 * north / 6366197.724 / 0.9996) / 2) + Math
										.sin(2 * north / 6366197.724 / 0.9996)
										* Math.pow(
												Math.cos(north / 6366197.724 / 0.9996),
								...
								* (1 - 0.006739496742
								...
								/ 6366197.724
								/ 0.9996)))
						* Math.tan((north - 0.9996 * 6399593.625 * (north
								/ 6366197.724
								/ 0.9996
								- 0.006739496742
								* 3
								...
								* (1 - 0.006739496742
								...
								+ north
								/ 6366197.724
								/ 0.9996)) - north / 6366197.724 / 0.9996)
				* 3
				/ 2)
				* (Math.atan(Math.cos(Math.atan((Math.exp((Easting - 500000)
						/ (0.9996 * 6399593.625 / Math
